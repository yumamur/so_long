...
# define MSG_LESSWALL	".ber file does not contain enough walls\n"
...
# define MSG_MAPOVRSZ	"Can not display block-size which is smaller than 8x8\n"

# define SLE_MAPGENER			0x000ff0

# define MSG_CONFIG		"Configure \"\033[1muser.cfg\033[m\" and retry"
